...
///
/// headingDeg: 0=N, 90=E
/// pitchDeg: 사용자님 코드에서 "보정된 pitch" (지평선 기준 0으로 캘리브레이션된 값)
/// rollDeg:  사용자님 코드에서 "보정된 roll"
ScreenPoint projectAltAzToScreen({
  ...
  // roll 적용 전 "월드 기준" 좌표
  double xWorld = (dAz / (hFovDeg / 2)) * (size.width / 2);
  double yWorld = (-dAlt / (vFovDeg / 2)) * (size.height / 2);
