...
class ARKitNode {
  ARKitNode({
    ...
    this.isBillboard = false, // [추가됨] 1. 생성자에 파라미터 추가
    Vector3? position,
    Vector3? scale,
    Vector4? rotation,
    Vector3? eulerAngles,
  ...
  /// [추가됨] 2. 빌보드 속성 변수 선언
  /// If true, the node will always face the camera.
  final bool isBillboard;
  ...
  Map<String, dynamic> toMap() => <String, dynamic>{
        ...
        'isBillboard': isBillboard, // [추가됨] 3. 네이티브로 보낼 맵에 추가
